    ...
    updatePcCase(
      ...
      } },
      {
        ...
        onError: (e: any) => {
          ...
          toast.error(e?.message || "Failed to update PC Case");
        },
      }
    );
  };
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <FormField name="maxGpuLengthMm" control={form.control} render={({ field }) => (
                <FormItem>
                  ...
                  <Input id="maxGpuLengthMm" type="number" {...field} value={field.value ?? ""} onChange={(e) => { const v = e.target.value; field.onChange(v === "" ? undefined : parseInt(v, 10)); }} />
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField name="maxCpuCoolerHeightMm" control={form.control} render={({ field }) => (
                <FormItem>
                  ...
                  <Input id="maxCpuCoolerHeightMm" type="number" {...field} value={field.value ?? ""} onChange={(e) => { const v = e.target.value; field.onChange(v === "" ? undefined : parseInt(v, 10)); }} />
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField name="psuFormFactor" control={form.control} render={({ field }) => (
                <FormItem>
                  ...
                  <Input id="psuFormFactor" placeholder="e.g., ATX, SFX" {...field} value={field.value ?? ""} onChange={(e) => field.onChange(e.target.value === "" ? undefined : e.target.value)} />
                  <FormMessage />
                </FormItem>
              )} />
            </div>

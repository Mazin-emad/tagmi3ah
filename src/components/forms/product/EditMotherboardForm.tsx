...
export default function EditMotherboardForm({
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      socket: product.socket ?? undefined,
      chipset: product.chipset ?? undefined,
      formFactor: product.formFactor ?? undefined,
      ramType: product.ramType ?? undefined,
      ramSlots: product.ramSlots ?? undefined,
      maxMemorySpeedMHz: product.maxMemorySpeedMHz ?? undefined,
      pcieVersion: product.pcieVersion ?? undefined,
      m2Slots: product.m2Slots ?? undefined,
